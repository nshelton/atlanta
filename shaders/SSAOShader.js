...
THREE.SSAOShader = {
	...
	fragmentShader: [
		...
		"const float noiseAmount = 1.;", // dithering amount

		"const float diffArea = 2.;",   // self-shadowing reduction
		"const float gDisplace = 0.2;",  // gauss bell center
		...
		"void main() {",
			...
			"gl_FragColor = vec4( final * 1.5, 1.0 ) ;",
